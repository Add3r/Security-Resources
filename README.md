...
| **Computer Science Introductory Material**           | **If you're new to Linux**        |
|-----------------------------------------------------|-----------------------------------|
| 📚 Post Covid-19, with more people reaching out to up-skill in the Cyber Security field, we recommend going through the following Computer science introductory material before deep diving into security content: | 🐧 Try, free Linux courses |
| 🌐[ Khan Academy: Computer Science](https://www.khanacademy.org/computing/computer-science/computers-and-internet-code-org) | 🐧 [Linux Journey](https://linuxjourney.com/) |
| 🎓 [ Edx: Computer Science Fundamentals](https://www.edx.org/learn/computer-science/stanford-university-computer-science-101) | 🐧 [Introduction to Linux](https://training.linuxfoundation.org/training/introduction-to-linux/) |
| ▶️ [ Crash Course: Computer Science Playlist](https://www.youtube.com/playlist?list=PL8dPuuaLjXtNlUrzyH5r6jN9ulIgZBpdo) |                                   |
| For practical fundamentals in Cyber Security, consider checking out: |                                   |
...
<p align="center">
  <a href="https://www.youtube.com/watch?v=SZQz9tkEHIg">
    <img src="https://img.youtube.com/vi/SZQz9tkEHIg/0.jpg" alt="Video">
  </a>
</p>
...
| [Satellite Hacking](https://hackasat.com/learn/)| [SOC Analyst](https://www.antisyphontraining.com/event/soc-core-skills-3/) |
...
| 🖱️ [VulnHub](https://www.vulnhub.com/)                 | Vulnerable Virtual Machines in different areas of focus |
...
| 📰 [Mobile Apps Reverse Engineering](https://mas.owasp.org/crackmes/)        | Mobile Apps Rev and control bypass |
...
| [Platypus Infosec Melbourne](https://www.meetup.com/en-AU/platypus-infosec-melbourne/) | [OzSecCon](https://ozseccon.com/)                          |
| [Melbourne AWS Security User Group](https://www.meetup.com/en-AU/Melbourne-AWS-Security-User-Group/) | [BSIDES Canberra](https://www.bsidesau.com.au/) (and other states as well) |
| [Ruxmon Melbourne](https://www.meetup.com/en-AU/meetup-group-BPNYjOrM/)               | [CloudSec](https://www.cloudsec.com/)                     |
| [Melbourne DevSecOps User Group](https://www.meetup.com/en-AU/Melbourne-DevSecOps-User-Group/) | [AusCERT](https://www.auscert.org.au/)                     |
...
|---------------------------------------------------------------|-------------------------------------------------------------|
| [Hak5](https://www.youtube.com/channel/UC3s0BtrBJpwNDaflRSoiieQ)          | [Zero Days - Documentary on Stuxnet](http://www.zerodaysfilm.com/) |
